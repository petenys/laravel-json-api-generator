...
namespace PeteNys\Generator\Utils;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName, $ignoredFields)
    {
        ...
        $mappings = config('petenys.laravel_json_api_generator.from_table.doctrine_mappings', []);
        ...
        $this->defaultSearchable = config('petenys.laravel_json_api_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('petenys.laravel_json_api_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('petenys.laravel_json_api_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('petenys.laravel_json_api_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('petenys.laravel_json_api_generator.timestamps.deleted_at', 'deleted_at');
